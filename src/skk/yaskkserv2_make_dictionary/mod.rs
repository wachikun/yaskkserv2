...
//!
//! IndexAsciiHiraganaVec/IndexMap は midashi に対応する candidates の情報を保持する vec/map 。
//! vec/map に分かれているのは高速化のため。ほとんどのケースで高速な IndexAsciiHiraganaVec を
//! アクセスするだけで済む (map も信頼できないデータを扱うわけではないので FxHashMap を使用し
